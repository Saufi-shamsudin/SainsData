...
for i in range(1,30):
    iphone12 = []
    url = "https://www.amazon.com/Apple-iPhone-Graphite-Carrier-Subscription/product-reviews/B08L5R1CCC/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="+str(i)
    header={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36'}
...
# words that contained in iphone12 reviews
...
stop_words.extend(["iphone12","iphone","mobile","ios","apple","phone","amazon","good","xr","product","great","camera","price"])
